...
Add +rails-restapi+ gem to your gemfile and run bundle.

    gem 'rails-restapi'
    
For bleeding edge version use GitHub version

    gem 'rails-restapi', :git => 'git://github.com/Pajk/rails-restapi.git'
...
* Static class generator (e.g. to include in other program)
