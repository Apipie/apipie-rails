...
describe Apipie::ApipiesController do
  ...
  describe 'authorize document' do
    it 'if an authroize method is set' do
      test = false
      Apipie.configuration.authorize = proc do |_controller, _method, _doc|
        test = true
        true
      end
      get :index
    ...
    it 'remove all resources' do
      Apipie.configuration.authorize = proc do |&_args|
        false
      end
      get :index
    ...
    it 'remove all methods' do
      Apipie.configuration.authorize = proc do |_controller, method, _doc|
        !method
      end
      get :index
    ...
    it 'remove specific method' do
      ...
      Apipie.configuration.authorize = proc do |controller, method, _doc|
